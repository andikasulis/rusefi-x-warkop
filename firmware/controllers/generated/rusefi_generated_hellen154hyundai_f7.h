...
#define adc_channel_e_enum                                                     \
  0 = "NONE", 8 = "BK2 Wastegate Position - 22", 13 = "CLT", 14 = "IAT",       \
  12 = "K10 Sensor", 6 = "K2 Ignition Key Voltage",                            \
  30 = "K21 Ambient Temperature", 3 = "K54 A/C pressure", 29 = "K58 Oil Temp", \
  11 = "Map Sensor K31", 4 = "PPS 1", 20 = "PPS 2", 5 = "TPS 1", 21 = "TPS 2", \
  7 = "X10 AIN2", 10 = "X11 AIN1"
#define adc_channel_e_fullenum                                                 \
  "NONE", "INVALID", "INVALID", "K54 A/C pressure", "PPS 1", "TPS 1",          \
      "K2 Ignition Key Voltage", "X10 AIN2", "BK2 Wastegate Position - 22",    \
      "INVALID", "X11 AIN1", "Map Sensor K31", "K10 Sensor", "CLT", "IAT",     \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "PPS 2", "TPS 2", \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "K58 Oil Temp", "K21 Ambient Temperature"
...
#define brain_input_pin_e_enum                                                 \
  0 = "NONE", 78 = "Crank - K17", 80 = "Exhaust Cam - K15",                    \
  79 = "Intake Cam - K62", 81 = "K40 VSS", 88 = "X4 Digital3",                 \
  87 = "X7 Digital2", 86 = "X9 Digital1"
#define brain_input_pin_e_fullenum                                             \
  "NONE", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",    \
      ...
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "Crank - K17",    \
      "Intake Cam - K62", "Exhaust Cam - K15", "K40 VSS", "INVALID",           \
      "INVALID", "INVALID", "INVALID", "X9 Digital1", "X7 Digital2",           \
      "X4 Digital3"
...
#define output_pin_e_enum                                                      \
  0 = "NONE", 309 = "Coil 1", 310 = "Coil 2", 311 = "Coil 3", 312 = "Coil 4",  \
  102 = "Fan Relay HI", 101 = "Fan Relay Low", 111 = "Fuel Pump K70",          \
  305 = "INJ_1 k25", 306 = "INJ_2 k26", 307 = "INJ_3 k27", 308 = "INJ_4 k28",  \
  95 = "K47 BK1 Wastegate Solenoid", 96 = "K48 OUT_RCV", 110 = "K87 AC Relay", \
  62 = "MIL", 112 = "Main Relay K64", 65 = "Tacho", 59 = "VVT1", 94 = "VVT2",  \
  11 = "X2 AuxLS3", 64 = "X3 AuxLS2", 53 = "X8 AuxLS1", 43 = "wg_dir",         \
  104 = "wg_dis", 42 = "wg_pwm"
#define output_pin_e_fullenum                                                  \
  "NONE", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",    \
      "INVALID", "INVALID", "INVALID", "INVALID", "X2 AuxLS3", "INVALID",      \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "wg_pwm",         \
      "wg_dir", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",         \
      "INVALID", "INVALID", "INVALID", "INVALID", "X8 AuxLS1", "INVALID",      \
      "INVALID", "INVALID", "INVALID", "INVALID", "VVT1", "INVALID",           \
      "INVALID", "MIL", "INVALID", "X3 AuxLS2", "Tacho", "INVALID", "INVALID", \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "VVT2", "K47 BK1 Wastegate Solenoid",              \
      "K48 OUT_RCV", "INVALID", "INVALID", "INVALID", "INVALID",               \
      "Fan Relay Low", "Fan Relay HI", "INVALID", "wg_dis", "INVALID",         \
      "INVALID", "INVALID", "INVALID", "INVALID", "K87 AC Relay",              \
      "Fuel Pump K70", "Main Relay K64", "INVALID", "INVALID", "INVALID",      \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      ...
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INJ_1 k25", "INJ_2 k26", "INJ_3 k27",  \
      "INJ_4 k28", "Coil 1", "Coil 2", "Coil 3", "Coil 4"
...
#define switch_input_pin_e_enum                                                \
  ...
  91 = "A57 AC Request", 88 = "X4 Digital3", 87 = "X7 Digital2",               \
  86 = "X9 Digital1"
