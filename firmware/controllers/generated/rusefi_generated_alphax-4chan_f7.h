...
#define adc_channel_e_enum                                                     \
  0 = "NONE", 12 = "B2 - MAP", 14 = "B3 - IAT", 2 = "B4 - O2", 5 = "B5 - TPS", \
  13 = "B7 - CLT", 7 = "C7 - CAM Hall/Digital", 9 = "D4 - TPS2",               \
  4 = "D5 - PPS", 15 = "F6 - PPS2", 6 = "F7 - Ignition Key Voltage",           \
  3 = "On-board MAP", 21 = "X1 - AIN1 and D5 on older boards",                 \
  20 = "X3 - AIN2", 11 = "X5 - AIN3", 8 = "X7 - AIN4"
#define adc_channel_e_fullenum                                                 \
  "NONE", "INVALID", "B4 - O2", "On-board MAP", "D5 - PPS", "B5 - TPS",        \
      "F7 - Ignition Key Voltage", "C7 - CAM Hall/Digital", "X7 - AIN4",       \
      "D4 - TPS2", "INVALID", "X5 - AIN3", "B2 - MAP", "B7 - CLT", "B3 - IAT", \
      "F6 - PPS2", "INVALID", "INVALID", "INVALID", "INVALID", "X3 - AIN2",    \
      "X1 - AIN1 and D5 on older boards"
...
#define brain_input_pin_e_enum                                                 \
  0 = "NONE", 80 = "C2 - Crank- (hall)", 19 = "C2/C3 Crank Sensor VR",         \
  78 = "C3 - Crank+ (hall)", 93 = "C4 - 2Step/Digital",                        \
  8 = "C7 - CAM Hall/Digital", 97 = "C7 - CAM2 VR", 86 = "E3 - Digital In 3",  \
  87 = "E4 - Digital In 4", 91 = "E5/E6 Cam Sensor VR",                        \
  81 = "E6 - Cam+ (hall)", 9 = "E7 - Flex"
#define brain_input_pin_e_fullenum                                             \
  "NONE", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",    \
      "INVALID", "C7 - CAM Hall/Digital", "E7 - Flex", "INVALID", "INVALID",   \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "C2/C3 Crank Sensor VR", "INVALID", "INVALID", "INVALID",     \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      ...
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "C3 - Crank+ (hall)", "INVALID", "C2 - Crank- (hall)",        \
      "E6 - Cam+ (hall)", "INVALID", "INVALID", "INVALID", "INVALID",          \
      "E3 - Digital In 3", "E4 - Digital In 4", "INVALID", "INVALID",          \
      "INVALID", "E5/E6 Cam Sensor VR", "INVALID", "C4 - 2Step/Digital",       \
      "INVALID", "INVALID", "INVALID", "C7 - CAM2 VR"
...
#define output_pin_e_enum                                                      \
  0 = "NONE", 10 = "A3 - Fuel Pump", 108 = "A4 - Tachometer",                  \
  104 = "A4 - Tachometer legacy up to rev F", 47 = "A6 - Ignition 1",          \
  71 = "A7 - Ignition 2", 105 = "A8 - Injector 1",                             \
  62 = "Aux10 - High2 legacy F4", 59 = "Aux2 - Inj 5", 94 = "Aux4 - Inj 6",    \
  68 = "Aux6 - Ignition 5", 26 = "Aux8 - Ignition 6",                          \
  65 = "Aux9 - High1 legacy F2", 106 = "B8 - Injector 2",                      \
  100 = "C1 - Fan Relay", 63 = "C8 - Idle", 61 = "D1 - Injector 3",            \
  41 = "D2 - Out Boost", 70 = "D6 - Ignition 3", 69 = "D7 - Ignition 4",       \
  60 = "E1 - Injector 4", 109 = "E2 - Out NOS", 43 = "F1 - Idle2",             \
  27 = "F2 - VVT#1 rev G", 72 = "F4 - VVT#2 rev G", 110 = "F5 - MAIN",         \
  345 = "MS IO-Box 0 OUT 1", 346 = "MS IO-Box 0 OUT 2",                        \
  347 = "MS IO-Box 0 OUT 3", 348 = "MS IO-Box 0 OUT 4"
#define output_pin_e_fullenum                                                  \
  "NONE", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",    \
      "INVALID", "INVALID", "INVALID", "A3 - Fuel Pump", "INVALID", "INVALID", \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "Aux8 - Ignition 6", "F2 - VVT#1 rev G", "INVALID",           \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "D2 - Out Boost", "INVALID", "F1 - Idle2", "INVALID", "INVALID",         \
      "INVALID", "A6 - Ignition 1", "INVALID", "INVALID", "INVALID",           \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "Aux2 - Inj 5", "E1 - Injector 4",                 \
      "D1 - Injector 3", "Aux10 - High2 legacy F4", "C8 - Idle", "INVALID",    \
      "Aux9 - High1 legacy F2", "INVALID", "INVALID", "Aux6 - Ignition 5",     \
      "D7 - Ignition 4", "D6 - Ignition 3", "A7 - Ignition 2",                 \
      "F4 - VVT#2 rev G", "INVALID", "INVALID", "INVALID", "INVALID",          \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "Aux4 - Inj 6",   \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "C1 - Fan Relay", \
      "INVALID", "INVALID", "INVALID", "A4 - Tachometer legacy up to rev F",   \
      "A8 - Injector 1", "B8 - Injector 2", "INVALID", "A4 - Tachometer",      \
      "E2 - Out NOS", "F5 - MAIN", "INVALID", "INVALID", "INVALID", "INVALID", \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      ...
      "MS IO-Box 0 OUT 3", "MS IO-Box 0 OUT 4"
...
#define SIGNATURE_HASH 2346575149
...
#define switch_input_pin_e_enum                                                \
  0 = "NONE", 80 = "C2 - Crank- (hall)", 78 = "C3 - Crank+ (hall)",            \
  93 = "C4 - 2Step/Digital", 8 = "C7 - CAM Hall/Digital",                      \
  85 = "D3 - Digital In 2", 86 = "E3 - Digital In 3",                          \
  87 = "E4 - Digital In 4", 81 = "E6 - Cam+ (hall)", 88 = "F3 - Digital In 5"
#define switch_input_pin_e_fullenum                                            \
  "NONE", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",    \
      "INVALID", "C7 - CAM Hall/Digital", "INVALID", "INVALID", "INVALID",     \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      ...
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "C3 - Crank+ (hall)", "INVALID", "C2 - Crank- (hall)",                   \
      "E6 - Cam+ (hall)", "INVALID", "INVALID", "INVALID",                     \
      "D3 - Digital In 2", "E3 - Digital In 3", "E4 - Digital In 4",           \
      "F3 - Digital In 5", "INVALID", "INVALID", "INVALID", "INVALID",         \
      "C4 - 2Step/Digital"
...
#define TS_SIGNATURE "rusEFI master.2025.12.18.alphax-4chan_f7.2346575149"
