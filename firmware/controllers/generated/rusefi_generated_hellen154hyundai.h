...
#define adc_channel_e_enum                                                     \
  0 = "NONE", 16 = "BK2 Wastegate Position - 22", 13 = "CLT", 14 = "IAT",      \
  12 = "K10 Sensor", 6 = "K2 Ignition Key Voltage",                            \
  1 = "K21 Ambient Temperature", 3 = "K54 A/C pressure", 2 = "K58 Oil Temp",   \
  11 = "Map Sensor K31", 4 = "PPS 1", 15 = "PPS 2", 5 = "TPS 1", 9 = "TPS 2",  \
  7 = "X10 AIN2", 10 = "X11 AIN1"
#define adc_channel_e_fullenum                                                 \
  "NONE", "K21 Ambient Temperature", "K58 Oil Temp", "K54 A/C pressure",       \
      "PPS 1", "TPS 1", "K2 Ignition Key Voltage", "X10 AIN2", "INVALID",      \
      "TPS 2", "X11 AIN1", "Map Sensor K31", "K10 Sensor", "CLT", "IAT",       \
      "PPS 2", "BK2 Wastegate Position - 22"
...
#define brain_input_pin_e_enum                                                 \
  0 = "NONE", 9 = "Cam - K15", 8 = "Cam - K62 rev B", 87 = "Cam - K62 rev C",  \
  19 = "Crank - K17 rev B", 86 = "Crank - K17 rev C", 93 = "K40 VSS",          \
  80 = "X4 Digital3", 79 = "X7 Digital2", 78 = "X9 Digital1"
#define brain_input_pin_e_fullenum                                             \
  "NONE", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",    \
      "INVALID", "Cam - K62 rev B", "Cam - K15", "INVALID", "INVALID",         \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "Crank - K17 rev B", "INVALID", "INVALID", "INVALID",         \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      ...
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "X9 Digital1", "X7 Digital2", "X4 Digital3", "INVALID",       \
      "INVALID", "INVALID", "INVALID", "INVALID", "Crank - K17 rev C",         \
      "Cam - K62 rev C", "INVALID", "INVALID", "INVALID", "INVALID",           \
      "INVALID", "K40 VSS"
...
#define output_pin_e_enum                                                      \
  0 = "NONE", 53 = "Aux P66", 11 = "Aux P67", 103 = "Aux P68", 47 = "Coil 1",  \
  71 = "Coil 2", 70 = "Coil 3", 69 = "Coil 4", 102 = "Fan Relay HI",           \
  101 = "Fan Relay Low", 111 = "Fuel Pump K70", 105 = "INJ_1 k25",             \
  106 = "INJ_2 k26", 61 = "INJ_3 k27", 60 = "INJ_4 k28",                       \
  95 = "K47 BK1 Wastegate Solenoid", 110 = "K87 AC Relay", 62 = "MIL",         \
  112 = "Main Relay K64", 65 = "Tacho", 59 = "VVT1", 94 = "VVT2",              \
  25 = "X2 AuxLS3", 64 = "X3 AuxLS2", 21 = "X8 AuxLS1", 43 = "wg_dir",         \
  104 = "wg_dis", 42 = "wg_pwm"
#define output_pin_e_fullenum                                                  \
  "NONE", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",    \
      "INVALID", "INVALID", "INVALID", "INVALID", "Aux P67", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "X8 AuxLS1", "INVALID", "INVALID", "INVALID",      \
      "X2 AuxLS3", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",      \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "wg_pwm",         \
      "wg_dir", "INVALID", "INVALID", "INVALID", "Coil 1", "INVALID",          \
      "INVALID", "INVALID", "INVALID", "INVALID", "Aux P66", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "VVT1", "INJ_4 k28",         \
      "INJ_3 k27", "MIL", "INVALID", "X3 AuxLS2", "Tacho", "INVALID",          \
      "INVALID", "INVALID", "Coil 4", "Coil 3", "Coil 2", "INVALID",           \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "VVT2", "K47 BK1 Wastegate Solenoid",   \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "Fan Relay Low",  \
      "Fan Relay HI", "Aux P68", "wg_dis", "INJ_1 k25", "INJ_2 k26",           \
      "INVALID", "INVALID", "INVALID", "K87 AC Relay", "Fuel Pump K70",        \
      "Main Relay K64"
...
#define SIGNATURE_HASH 1337215914
...
#define switch_input_pin_e_enum                                                \
  0 = "NONE", 90 = "A29 Brake Input", 92 = "A43 Clutch Input",                 \
  91 = "A57 AC Request", 80 = "X4 Digital3", 79 = "X7 Digital2",               \
  78 = "X9 Digital1"
#define switch_input_pin_e_fullenum                                            \
  "NONE", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",    \
      ...
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "X9 Digital1",    \
      "X7 Digital2", "X4 Digital3", "INVALID", "INVALID", "INVALID",           \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "A29 Brake Input", "A57 AC Request", "A43 Clutch Input"
...
#define TS_SIGNATURE "rusEFI master.2025.12.18.hellen154hyundai.1337215914"
