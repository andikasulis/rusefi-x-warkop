...
#define adc_channel_e_enum                                                     \
  0 = "NONE", 12 = "A2 Battery Sense", 3 = "B2 - Analog/Digital Input",        \
  4 = "B3 - Analog/Digital Input", 5 = "B4 - Analog/Digital Input",            \
  6 = "B5 - Analog/Digital Input", 7 = "B7 - Analog/Digital Input",            \
  8 = "C1 - Analog/Digital Input 6", 15 = "C2 - Analog/Digital Input 7",       \
  16 = "C4 - Analog/Digital Input 8"
#define adc_channel_e_fullenum                                                 \
  "NONE", "INVALID", "INVALID", "B2 - Analog/Digital Input",                   \
      "B3 - Analog/Digital Input", "B4 - Analog/Digital Input",                \
      "B5 - Analog/Digital Input", "B7 - Analog/Digital Input",                \
      "C1 - Analog/Digital Input 6", "INVALID", "INVALID", "INVALID",          \
      "A2 Battery Sense", "INVALID", "INVALID", "C2 - Analog/Digital Input 7", \
...
#define brain_input_pin_e_enum                                                 \
  0 = "NONE", 9 = "C1 - Analog/Digital Input 6",                               \
  38 = "C2 - Analog/Digital Input 7",                                          \
  3 = "C3 - Digital Input with 2.7K pull up",                                  \
  39 = "C4 - Analog/Digital Input 8"
#define brain_input_pin_e_fullenum                                             \
  "NONE", "INVALID", "INVALID", "C3 - Digital Input with 2.7K pull up",        \
      ...
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "C2 - Analog/Digital Input 7", "C4 - Analog/Digital Input 8"
...
#define output_pin_e_enum                                                      \
  0 = "NONE", 25 = "A7 - Low Side", 42 = "A8 - Low Side",                      \
  43 = "B8 - Low Side", 10 = "C8 - Low Side"
#define output_pin_e_fullenum                                                  \
  "NONE", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",    \
      "INVALID", "INVALID", "INVALID", "C8 - Low Side", "INVALID", "INVALID",  \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "A7 - Low Side", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",  \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "A8 - Low Side",  \
      "B8 - Low Side"
...
#define SIGNATURE_HASH 1307774405
...
#define switch_input_pin_e_enum                                                \
  0 = "NONE", 4 = "B2 - Analog/Digital Input",                                 \
  5 = "B3 - Analog/Digital Input", 6 = "B4 - Analog/Digital Input",            \
  7 = "B5 - Analog/Digital Input", 8 = "B7 - Analog/Digital Input",            \
  9 = "C1 - Analog/Digital Input 6", 38 = "C2 - Analog/Digital Input 7",       \
  3 = "C3 - Digital Input with 2.7K pull up",                                  \
  39 = "C4 - Analog/Digital Input 8"
#define switch_input_pin_e_fullenum                                            \
  "NONE", "INVALID", "INVALID", "C3 - Digital Input with 2.7K pull up",        \
      "B2 - Analog/Digital Input", "B3 - Analog/Digital Input",                \
      "B4 - Analog/Digital Input", "B5 - Analog/Digital Input",                \
      "B7 - Analog/Digital Input", "C1 - Analog/Digital Input 6", "INVALID",   \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "C2 - Analog/Digital Input 7",          \
      "C4 - Analog/Digital Input 8"
...
#define TS_SIGNATURE "rusEFI master.2025.12.18.small-can-board.1307774405"
