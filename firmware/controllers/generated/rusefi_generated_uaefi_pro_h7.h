...
#define adc_channel_e_enum                                                     \
  0 = "NONE", 6 = "A7 Voltage From Key", 9 = "C14 TPS2",                       \
  8 = "C15 Fuel Pressure / AUX3", 2 = "C3 AUX2", 15 = "C4 PPS2",               \
  1 = "D1 AUX1", 7 = "D10 A/C Request / BUTTON2", 5 = "D13 TPS1",              \
  14 = "D15 IAT", 13 = "D16 CLT Coolant", 10 = "D2 BUTTON1", 4 = "D6 PPS1",    \
  11 = "D9 MAP", 12 = "On-board MAP"
#define adc_channel_e_fullenum                                                 \
  "NONE", "D1 AUX1", "C3 AUX2", "INVALID", "D6 PPS1", "D13 TPS1",              \
      "A7 Voltage From Key", "D10 A/C Request / BUTTON2",                      \
      "C15 Fuel Pressure / AUX3", "C14 TPS2", "D2 BUTTON1", "D9 MAP",          \
      "On-board MAP", "D16 CLT Coolant", "D15 IAT", "C4 PPS2"
...
#define brain_input_pin_e_enum                                                 \
  0 = "NONE", 9 = "C15 Fuel Pressure / AUX3",                                  \
  67 = "C17 VR2-/HALL max9924 best for normal 12+ tooth wheels",               \
  66 = "C18 VR1+ Discrete for low count wheel", 78 = "C5 CAM 1 / HALL1",       \
  79 = "C6 CAM 2 / HALL2", 80 = "C7 HALL3", 81 = "C9 BUTTON3", 2 = "D1 AUX1",  \
  8 = "D10 A/C Request / BUTTON2", 19 = "D2 BUTTON1", 77 = "D5 FLEX"
#define brain_input_pin_e_fullenum                                             \
  "NONE", "INVALID", "D1 AUX1", "INVALID", "INVALID", "INVALID", "INVALID",    \
      "INVALID", "D10 A/C Request / BUTTON2", "C15 Fuel Pressure / AUX3",      \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "D2 BUTTON1", "INVALID", "INVALID",     \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      ...
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "C18 VR1+ Discrete for low count wheel",           \
      "C17 VR2-/HALL max9924 best for normal 12+ tooth wheels", "INVALID",     \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "D5 FLEX", "C5 CAM 1 / HALL1", "C6 CAM 2 / HALL2", \
      "C7 HALL3", "C9 BUTTON3"
...
#define canReWidebandHwIndex_enum                                              \
  "INVALID", "Idx 1", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",   \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
...
#define output_pin_e_enum                                                      \
  0 = "NONE", 10 = "B1 injector output 6", 26 = "B10 Coil 6",                  \
  69 = "B11 Coil 4", 70 = "B12 Coil 3", 68 = "B13 Coil 5", 71 = "B14 Coil 2",  \
  47 = "B15 Coil 1",                                                           \
  40 = "B16 Low Side output 4 / Fuel Pump Relay (has flyback D5)",             \
  63 = "B17 Low Side output 3 (has flyback D4)",                               \
  62 = "B18 VVT2 or Idle or Low Side output 2 (has flyback D3)",               \
  52 = "B2 injector output 5", 60 = "B3 injector output 4",                    \
  61 = "B4 injector output 3", 11 = "B5 injector output 2",                    \
  53 = "B6 injector output 1",                                                 \
  65 = "B7 VVT1 or Low Side output 1 (has flyback D2)",                        \
  72 = "B8 Fan Relay Weak Low Side output 2 (no flyback here)",                \
  27 = "B9 Main Relay Weak Low Side output 1 (no flyback here)",               \
...
#define output_pin_e_fullenum                                                  \
  "NONE", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",    \
      "INVALID", "INVALID", "INVALID", "B1 injector output 6",                 \
      "B5 injector output 2", "INVALID", "INVALID", "INVALID", "INVALID",      \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "B10 Coil 6",                \
      "B9 Main Relay Weak Low Side output 1 (no flyback here)", "INVALID",     \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",                   \
      "B16 Low Side output 4 / Fuel Pump Relay (has flyback D5)", "INVALID",   \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "B15 Coil 1",     \
      "INVALID", "INVALID", "INVALID", "INVALID", "B2 injector output 5",      \
      "B6 injector output 1", "INVALID", "INVALID", "INVALID", "INVALID",      \
      "INVALID", "INVALID", "B3 injector output 4", "B4 injector output 3",    \
      "B18 VVT2 or Idle or Low Side output 2 (has flyback D3)",                \
      "B17 Low Side output 3 (has flyback D4)", "INVALID",                     \
      "B7 VVT1 or Low Side output 1 (has flyback D2)", "INVALID", "INVALID",   \
      "B13 Coil 5", "B11 Coil 4", "B12 Coil 3", "B14 Coil 2",                  \
      "B8 Fan Relay Weak Low Side output 2 (no flyback here)", "INVALID",      \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      ...
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "MS IO-Box 0 OUT 1", "MS IO-Box 0 OUT 2",                     \
...
#define sent_input_pin_e_enum                                                  \
  0 = "NONE", 79 = "C6 CAM 2 / HALL2", 80 = "C7 HALL3"
...
#define SIGNATURE_HASH 1031874742
...
#define switch_input_pin_e_enum                                                \
  0 = "NONE", 9 = "C15 Fuel Pressure / AUX3", 3 = "C3 AUX2",                   \
  81 = "C9 BUTTON3", 2 = "D1 AUX1", 8 = "D10 A/C Request / BUTTON2",           \
  19 = "D2 BUTTON1"
#define switch_input_pin_e_fullenum                                            \
  "NONE", "INVALID", "D1 AUX1", "C3 AUX2", "INVALID", "INVALID", "INVALID",    \
      "INVALID", "D10 A/C Request / BUTTON2", "C15 Fuel Pressure / AUX3",      \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "D2 BUTTON1", "INVALID", "INVALID",     \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      ...
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "C9 BUTTON3"
...
#define TS_SIGNATURE "rusEFI master.2025.12.18.uaefi_pro_h7.1031874742"
