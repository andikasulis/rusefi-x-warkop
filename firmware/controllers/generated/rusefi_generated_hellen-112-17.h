...
#define adc_channel_e_enum                                                     \
  0 = "NONE", 7 = "A07 TODO", 12 = "A09 Analog Input", 9 = "A10 Analog Input", \
  15 = "A11 Analog Input", 8 = "A12 Analog Input", 2 = "A14 Analog Input",     \
  16 = "A19 Analog Input", 4 = "A21 PPS1", 5 = "B03 TPS Throttle Position 1",  \
  13 = "B15 CLT", 11 = "B19 MAP", 1 = "B20 TPS Throttle Position 2",           \
  14 = "B27 IAT"
#define adc_channel_e_fullenum                                                 \
  "NONE", "B20 TPS Throttle Position 2", "A14 Analog Input", "INVALID",        \
      "A21 PPS1", "B03 TPS Throttle Position 1", "INVALID", "A07 TODO",        \
      "A12 Analog Input", "A10 Analog Input", "INVALID", "B19 MAP",            \
      "A09 Analog Input", "B15 CLT", "B27 IAT", "A11 Analog Input",            \
      "A19 Analog Input"
...
#define brain_input_pin_e_enum                                                 \
  0 = "NONE", 19 = "B13 Crank VR+", 78 = "B31 Cam", 79 = "B32 VSS",            \
  77 = "B33 MAF frequency"
#define brain_input_pin_e_fullenum                                             \
  "NONE", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",    \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "B13 Crank VR+", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",  \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      ...
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "B33 MAF frequency",         \
      "B31 Cam", "B32 VSS"
...
#define output_pin_e_enum                                                      \
  0 = "NONE", 52 = "A01 low side 1.5A output",                                 \
  65 = "A02 low side 1.5A output", 72 = "A15 Main Relay",                      \
  63 = "A28 Tach Output", 40 = "A29 Fuel Consumption Output",                  \
  41 = "A31 Relay Output", 27 = "A40 Relay Output",                            \
  42 = "A41 Engine Radiator Fan", 43 = "A42 Fuel Pump Relay",                  \
  68 = "A51 relay output", 26 = "A52 relay output",                            \
  10 = "B35 Low Side Output", 11 = "B42 injector output 2",                    \
  61 = "B43 injector output 3", 53 = "B44 injector output 1",                  \
  60 = "B45 injector output 4", 62 = "B46 low side 1.5A output",               \
  71 = "B53 Coil 2", 70 = "B54 Coil 3", 69 = "B55 Coil 4", 47 = "B56 Coil 1"
#define output_pin_e_fullenum                                                  \
  "NONE", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",    \
      "INVALID", "INVALID", "INVALID", "B35 Low Side Output",                  \
      "B42 injector output 2", "INVALID", "INVALID", "INVALID", "INVALID",     \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "A52 relay output",          \
      "A40 Relay Output", "INVALID", "INVALID", "INVALID", "INVALID",          \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "A29 Fuel Consumption Output", "A31 Relay Output", \
      "A41 Engine Radiator Fan", "A42 Fuel Pump Relay", "INVALID", "INVALID",  \
      "INVALID", "B56 Coil 1", "INVALID", "INVALID", "INVALID", "INVALID",     \
      "A01 low side 1.5A output", "B44 injector output 1", "INVALID",          \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",                   \
      "B45 injector output 4", "B43 injector output 3",                        \
      "B46 low side 1.5A output", "A28 Tach Output", "INVALID",                \
      "A02 low side 1.5A output", "INVALID", "INVALID", "A51 relay output",    \
      "B55 Coil 4", "B54 Coil 3", "B53 Coil 2", "A15 Main Relay"
...
#define switch_input_pin_e_enum                                                \
  0 = "NONE", 81 = "A20 Switch Input", 46 = "A23 Switch Input",                \
  31 = "A34 Switch Input", 30 = "A35 Switch Input", 44 = "A36 Switch Input",   \
  45 = "A47 Switch Input"
#define switch_input_pin_e_fullenum                                            \
  "NONE", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",    \
      ...
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",                   \
      "A35 Switch Input", "A34 Switch Input", "INVALID", "INVALID", "INVALID", \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "A36 Switch Input", "A47 Switch Input", \
      "A23 Switch Input", "INVALID", "INVALID", "INVALID", "INVALID",          \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
