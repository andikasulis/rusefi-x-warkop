...
#define adc_channel_e_enum                                                     \
  0 = "NONE", 16 = "16A AUX 2", 11 = "16B - Digital/analog input 2",           \
  5 = "18B - TPS1", 4 = "19A PPS1", 13 = "19B - CLT", 20 = "20A PPS2",         \
  14 = "20B - IAT", 2 = "21B MAP", 21 = "22B TPS2",                            \
  15 = "23A - Digital/analog Input 4", 3 = "24A - Digital/analog Input 3",     \
  8 = "25B - Digital/analog Input 5", 9 = "28B AUX1",                          \
  6 = "9A Voltage From Key", 12 = "On-board MAP Sensor"
#define adc_channel_e_fullenum                                                 \
  "NONE", "INVALID", "21B MAP", "24A - Digital/analog Input 3", "19A PPS1",    \
      "18B - TPS1", "9A Voltage From Key", "INVALID",                          \
      "25B - Digital/analog Input 5", "28B AUX1", "INVALID",                   \
      "16B - Digital/analog input 2", "On-board MAP Sensor", "19B - CLT",      \
      "20B - IAT", "23A - Digital/analog Input 4", "16A AUX 2", "INVALID",     \
      "INVALID", "INVALID", "20A PPS2", "22B TPS2"
...
#define brain_input_pin_e_enum                                                 \
  0 = "NONE", 78 = "14A Hall Input 1", 79 = "15A Hall Input 2",                \
  39 = "16A AUX 2", 34 = "16B - Digital/analog input 2",                       \
  19 = "17A/17B VR Input 1 (Discrete)", 88 = "17B - Digital input 1",          \
  86 = "21A Knock 1 / Digital input 7", 87 = "22A Knock 2 / Digital input 8",  \
  75 = "23A - Digital/analog Input 4", 8 = "23A/24A VR Input 2 (Discrete)",    \
  4 = "24A - Digital/analog Input 3", 93 = "24A/25A VR Input 3 (MAX9924)",     \
  81 = "24B - Digital Input 6", 9 = "25B - Digital/analog Input 5",            \
  80 = "27A Flex Fuel"
#define brain_input_pin_e_fullenum                                             \
  "NONE", "INVALID", "INVALID", "INVALID", "24A - Digital/analog Input 3",     \
      "INVALID", "INVALID", "INVALID", "23A/24A VR Input 2 (Discrete)",        \
      "25B - Digital/analog Input 5", "INVALID", "INVALID", "INVALID",         \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "17A/17B VR Input 1 (Discrete)", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",                   \
      "16B - Digital/analog input 2", "INVALID", "INVALID", "INVALID",         \
      "INVALID", "16A AUX 2", "INVALID", "INVALID", "INVALID", "INVALID",      \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "23A - Digital/analog Input 4", "INVALID", "INVALID",         \
      "14A Hall Input 1", "15A Hall Input 2", "27A Flex Fuel",                 \
      "24B - Digital Input 6", "INVALID", "INVALID", "INVALID", "INVALID",     \
      "21A Knock 1 / Digital input 7", "22A Knock 2 / Digital input 8",        \
      "17B - Digital input 1", "INVALID", "INVALID", "INVALID", "INVALID",     \
...
#define output_pin_e_enum                                                      \
  0 = "NONE", 72 = "10A Coil 8", 69 = "10B Coil 4", 27 = "11A Coil 7",         \
  70 = "11B Coil 3", 26 = "12A Coil 6", 71 = "12B Coil 2", 68 = "13A Coil 5",  \
  47 = "13B Coil 1", 332 = "14B - Tachometer Output", 328 = "1A - Injector 8", \
  324 = "1B - Injector 4", 327 = "2A - Injector 7", 323 = "2B - Injector 3",   \
  326 = "3A - Injector 6", 322 = "3B - Injector 2", 325 = "4A - Injector 5",   \
  321 = "4B - Injector 1", 336 = "5A Main Relay", 329 = "5B Fuel Pump Relay",  \
  334 = "6A LS3", 330 = "6B Idle Output", 335 = "7A LS4", 333 = "8A LS5"
#define output_pin_e_fullenum                                                  \
  "NONE", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",    \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "12A Coil 6", "11A Coil 7", "INVALID", "INVALID", "INVALID",  \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "13B Coil 1", "INVALID",     \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "13A Coil 5", "10B Coil 4", "11B Coil 3", "12B Coil 2",       \
      "10A Coil 8", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",     \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      ...
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "4B - Injector 1", "3B - Injector 2",   \
      "2B - Injector 3", "1B - Injector 4", "4A - Injector 5",                 \
      "3A - Injector 6", "2A - Injector 7", "1A - Injector 8",                 \
      "5B Fuel Pump Relay", "6B Idle Output", "INVALID",                       \
      "14B - Tachometer Output", "8A LS5", "6A LS3", "7A LS4", "5A Main Relay"
...
#define switch_input_pin_e_enum                                                \
  0 = "NONE", 85 = "15B - Digital In 1", 39 = "16A AUX 2",                     \
  34 = "16B - Digital/analog input 2", 88 = "17B - Digital input 1",           \
  86 = "21A Knock 1 / Digital input 7", 87 = "22A Knock 2 / Digital input 8",  \
  75 = "23A - Digital/analog Input 4", 4 = "24A - Digital/analog Input 3",     \
  81 = "24B - Digital Input 6", 9 = "25B - Digital/analog Input 5"
#define switch_input_pin_e_fullenum                                            \
  "NONE", "INVALID", "INVALID", "INVALID", "24A - Digital/analog Input 3",     \
      ...
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "16B - Digital/analog input 2",         \
      "INVALID", "INVALID", "INVALID", "INVALID", "16A AUX 2", "INVALID",      \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID",                              \
      "23A - Digital/analog Input 4", "INVALID", "INVALID", "INVALID",         \
      "INVALID", "INVALID", "24B - Digital Input 6", "INVALID", "INVALID",     \
      "INVALID", "15B - Digital In 1", "21A Knock 1 / Digital input 7",        \
