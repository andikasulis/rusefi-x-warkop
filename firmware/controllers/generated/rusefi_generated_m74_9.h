...
#define adc_channel_e_enum                                                     \
  0 = "NONE", 13 = "ETB TPS position sensor 1 signal",                         \
  14 = "ETB TPS position sensor 2 signal", 2 = "MAF/MAP sensor signal",        \
  11 = "Pedal position sensor 1 signal PPS1",                                  \
  12 = "Pedal position sensor 2 signal PPS2"
#define adc_channel_e_fullenum                                                 \
  "NONE", "INVALID", "MAF/MAP sensor signal", "INVALID", "INVALID", "INVALID", \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",                   \
      "Pedal position sensor 1 signal PPS1",                                   \
      "Pedal position sensor 2 signal PPS2",                                   \
      "ETB TPS position sensor 1 signal", "ETB TPS position sensor 2 signal"
...
#define brain_input_pin_e_enum                                                 \
  0 = "NONE", 27 = "Camshaft position sensor signal",                          \
  90 = "Crank position sensor (pin A)", 30 = "Vehicle speed sensor input"
#define brain_input_pin_e_fullenum                                             \
  "NONE", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",    \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "Camshaft position sensor signal", "INVALID",      \
      "INVALID", "Vehicle speed sensor input", "INVALID", "INVALID",           \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      ...
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "Crank position sensor (pin A)"
...
#define engine_type_e_auto_enum                                                \
  ...
  24 = "ET_TEST_WITH_BOSCH_QUICK_START", 105 = "FERRARI_F136",                 \
  3 = "FORD_ASPIRE_1996", 11 = "FORD_COYOTE", 14 = "FORD_ESCORT_GT",           \
  ...
  98 = "GM_SBC", 49 = "GM_SBC_GEN5", 8 = "GY6_139QMB", 6 = "HARLEY",           \
  ...
  92 = "SIMULATOR_CONFIG", 56 = "SUBARU_2011", 70 = "SUBARU_EG33",             \
  17 = "TCU_4R70W", 100 = "TEST_100", 101 = "TEST_101", 18 = "TEST_33816",     \
  ...
  67 = "UNUSED67", 94 = "UNUSED94", 97 = "UNUSED_97", 77 = "VAG_5_CYL",        \
...
#define gppwm_channel_e_enum                                                   \
  "Zero", "TPS", "MAP", "CLT", "IAT", "Fuel Load", "Ignition Load",            \
      "Aux Temp 1", "Aux Temp 2", "Accel Pedal", "Battery Voltage",            \
      "VVT 1 In Actual", "VVT 1 Ex Actual", "VVT 2 In Actual",                 \
      "VVT 2 Ex Actual", "Ethanol (Flex) %", "Aux Linear 1", "Aux Linear 2",   \
      "GPPWM Output 1", "GPPWM Output 2", "GPPWM Output 3", "GPPWM Output 4",  \
      "Lua Gauge 1", "Lua Gauge 2", "RPM", "Gear (detected)", "Baro pressure", \
      "EGT 1", "EGT 2", "Aux Linear 3", "Aux Linear 4", "Vehicle speed",       \
...
#define output_pin_e_enum                                                      \
  0 = "NONE", 235 = "Air compressor control",                                  \
  215 = "Coil 1 (< +2.5v) / Coils 1,4",                                        \
  216 = "Coil 2  (< +2.5v) (not populated)",                                   \
  217 = "Coil 3  (< +2.5v) / Coils 2,4",                                       \
  218 = "Coil 4  (< +2.5v) (not populated)", 223 = "EVAP solenoid control",    \
  233 = "FAN 1 relay", 234 = "FAN 2 relay", 231 = "Fuel pump relay",           \
  222 = "Injector 1", 221 = "Injector 2", 220 = "Injector 3",                  \
  219 = "Injector 4", 224 = "Oxygen sensor 1 heater",                          \
  225 = "Oxygen sensor 2 heater", 232 = "Secondary starter relay",             \
  236 = "Unknown out (OUT18)"
#define output_pin_e_fullenum                                                  \
  "NONE", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",    \
      ...
      "Coil 1 (< +2.5v) / Coils 1,4", "Coil 2  (< +2.5v) (not populated)",     \
      "Coil 3  (< +2.5v) / Coils 2,4", "Coil 4  (< +2.5v) (not populated)",    \
      "Injector 4", "Injector 3", "Injector 2", "Injector 1",                  \
      "EVAP solenoid control", "Oxygen sensor 1 heater",                       \
      "Oxygen sensor 2 heater", "INVALID", "INVALID", "INVALID", "INVALID",    \
      "INVALID", "Fuel pump relay", "Secondary starter relay", "FAN 1 relay",  \
      "FAN 2 relay", "Air compressor control", "Unknown out (OUT18)"
...
#define pin_input_mode_e_enum                                                  \
  "DEFAULT", "PULLUP", "PULLDOWN", "INVALID", "INVERTED DEFAULT",              \
      "INVERTED PULLUP", "INVERTED PULLDOWN"
...
#define switch_input_pin_e_enum                                                \
  0 = "NONE", 67 = "Air conditioner control input",                            \
  92 = "Air conditioner pressure sensor (2 level)",                            \
  87 = "CLT Coolant temperature sensor signal",                                \
  27 = "Camshaft position sensor signal",                                      \
  36 = "ETB TPS position sensor 1 signal",                                     \
  37 = "ETB TPS position sensor 2 signal", 88 = "IAT intake sensor signal",    \
  3 = "MAF/MAP sensor signal", 85 = "Oxygen sensor 1 signal",                  \
  34 = "Pedal position sensor 1 signal PPS1",                                  \
  35 = "Pedal position sensor 2 signal PPS2"
#define switch_input_pin_e_fullenum                                            \
  "NONE", "INVALID", "INVALID", "MAF/MAP sensor signal", "INVALID", "INVALID", \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "Camshaft position sensor signal",      \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "Pedal position sensor 1 signal PPS1",                                   \
      "Pedal position sensor 2 signal PPS2",                                   \
      "ETB TPS position sensor 1 signal", "ETB TPS position sensor 2 signal",  \
      ...
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",                   \
      "Air conditioner control input", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "INVALID", "INVALID", "INVALID", "INVALID",        \
      "INVALID", "INVALID", "Oxygen sensor 1 signal", "INVALID",               \
      "CLT Coolant temperature sensor signal", "IAT intake sensor signal",     \
      "INVALID", "INVALID", "INVALID",                                         \
      "Air conditioner pressure sensor (2 level)"
...
#define trigger_type_e_auto_enum                                               \
  ...
  30 = "TT_CHRYSLER_NGC_36_2_2", 88 = "TT_CUSTOM_1", 89 = "TT_CUSTOM_2",       \
  6 = "TT_DAIHATSU_3_CYL", 81 = "TT_DAIHATSU_4_CYL", 83 = "TT_DEV",            \
  2 = "TT_DODGE_NEON_1995", 39 = "TT_DODGE_NEON_1995_ONLY_CRANK",              \
  14 = "TT_DODGE_NEON_2003_CAM", 32 = "TT_DODGE_NEON_2003_CRANK",              \
  19 = "TT_DODGE_RAM", 22 = "TT_DODGE_STRATUS", 41 = "TT_FIAT_IAW_P8",         \
  1 = "TT_FORD_ASPIRE", 42 = "TT_FORD_ST170", 65 = "TT_FORD_TFI_PIP",          \
  74 = "TT_GM_24x_3", 27 = "TT_GM_24x_5", 54 = "TT_GM_60_2_2_2",               \
  5 = "TT_GM_7X", 18 = "TT_HALF_MOON", 28 = "TT_HONDA_CBR_600",                \
  87 = "TT_HONDA_J30A2_24_1_1", 67 = "TT_HONDA_K_CAM_4_1",                     \
  ...
  53 = "TT_TRI_TACH", 90 = "TT_UNUSED", 56 = "TT_VVT_BARRA_3_PLUS_1",          \
...
#define vvt_mode_e_auto_enum                                                   \
  ...
  17 = "VVT_MITSUBISHI_4G9x", 20 = "VVT_MITSUBISHI_6G72",                      \
  11 = "VVT_NISSAN_MR", 9 = "VVT_NISSAN_VQ", 1 = "VVT_SINGLE_TOOTH",           \
  2 = "VVT_TOYOTA_3_TOOTH", 6 = "VVT_TOYOTA_4_1", 14 = "VVT_UNUSED14"
#define vvt_mode_e_enum                                                        \
  "Inactive", "Single Tooth", "Toyota 3 Tooth", "Miata NB2", "Mitsu 4G69",     \
      ...
      "Honda K Intake", "Nissan MR18", "Mitsu 3A92", "Sync by MAP", "INVALID", \
      "Mazda Skyactiv", "Honda K Exhaust", "Mitsubishi 4G92/93/94",            \
      "Mitsubishi 4G63", "Ford Coyote", "Mitsu 6G72", "Honda 600", "Mazda L",  \
      "Dev", "HR12DDR In", "INVALID", "INVALID", "vvt27", "vvt28"
